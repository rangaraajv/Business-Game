...
function toDhiwaal(){
    ...
    var p1a = document.getElementById("p2tp1").value;
    var p1b = document.getElementById("p3tp1").value;
    var p1c = document.getElementById("p4tp1").value;
    var p2a = document.getElementById("p1tp2").value;
    var p2b = document.getElementById("p3tp2").value;
    var p2c = document.getElementById("p4tp2").value;
    var p3a = document.getElementById("p1tp3").value;
    var p3b = document.getElementById("p2tp3").value;
    var p3c = document.getElementById("p4tp3").value;
    var p4a = document.getElementById("p1tp4").value;
    var p4b = document.getElementById("p2tp4").value;
    var p4c = document.getElementById("p3tp4").value;
    ...
    document.getElementById("p1bal").value = parseInt(p1Bal) + parseInt(p1a) + parseInt(p1b) + parseInt(p1c);
    document.getElementById("p2bal").value = parseInt(p2Bal) + parseInt(p2a) + parseInt(p2b) + parseInt(p2c);
    document.getElementById("p3bal").value = parseInt(p3Bal) + parseInt(p3a) + parseInt(p3b) + parseInt(p3c);
    document.getElementById("p4bal").value = parseInt(p4Bal) + parseInt(p4a) + parseInt(p4b) + parseInt(p4c);;
